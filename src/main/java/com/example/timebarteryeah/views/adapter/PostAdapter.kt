...
class PostAdapter(private val context: Context,
                  ...
                  private val userList: List<User?>) : RecyclerView.Adapter<PostAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val ui: View) : RecyclerView.ViewHolder(ui) {
        ...
        fun bindPost(post: Post, user: User) {
            ...
            ui.setOnClickListener {
                val toDetail = Intent(context, DetailPostActivity::class.java)
                toDetail.putExtra(Constant.Tag.USER_ID_POST, post.userId)
                ...
                toDetail.putExtra(Constant.Tag.AUTH, post.auth)
                ...
                toDetail.putExtra(Constant.Tag.POST_ACCEPTED_BY, post.acceptedBy)
